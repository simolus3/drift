...
///
/// By calling [driftWorkerMain] here, tabs connect to this worker by using
/// [connectToDriftWorker]. Drift will handle the communication channel needed
/// internally.
void main() {
  return driftWorkerMain(() => LazyDatabase(connectInWorker));
}
