...
abstract base class $Database extends i0.GeneratedDatabase {
  $Database(super.implementation);
  late final i1.Users users = i1.Users();
  late final i2.Posts posts = i2.Posts();
  late final i3.SearchInPosts searchInPosts = i3.SearchInPosts();
  late final i2.Likes likes = i2.Likes();
  late final i1.Follows follows = i1.Follows();
