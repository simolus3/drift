...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape7 users = Shape7(
      source: i0.VersionedTable(
        entityName: 'users',
        withoutRowId: false,
        isStrict: false,
      ...
      alias: null);
  late final Shape8 groups = Shape8(
      source: i0.VersionedTable(
        entityName: 'groups',
        withoutRowId: false,
        isStrict: false,
  ...
  late final Shape6 notes = Shape6(
      ...
      alias: null);
  late final Shape9 groupCount = Shape9(
      source: i0.VersionedView(
        entityName: 'group_count',
        createViewStmt:
            'CREATE VIEW group_count AS SELECT users.*, (SELECT COUNT(*) FROM "groups" WHERE owner = users.id) AS group_count FROM users;',
...
i1.GeneratedColumn<String> _column_19(String aliasedName) =>
    i1.GeneratedColumn<String>('name', aliasedName, false,
        ...
        defaultValue: const i1.CustomExpression('\'name\''));
i1.GeneratedColumn<String> _column_20(String aliasedName) => i1.GeneratedColumn<
...
i1.GeneratedColumn<int> _column_22(String aliasedName) =>
    i1.GeneratedColumn<int>('deleted', aliasedName, true,
        type: i1.DriftSqlType.int,
...
i1.GeneratedColumn<String> _column_25(String aliasedName) =>
    i1.GeneratedColumn<String>('search_terms', aliasedName, true,
        type: i1.DriftSqlType.string, $customConstraints: '');
...
i1.GeneratedColumn<String> _column_26(String aliasedName) =>
    i1.GeneratedColumn<String>('birthday', aliasedName, true,
        type: i1.DriftSqlType.string);
