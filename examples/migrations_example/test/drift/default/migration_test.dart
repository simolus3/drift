...
expect(v9_to_v10.groupsV10, await newDb.select(newDb.groups).get());
...
b.insertAll(oldDb.notes, v10_to_v11.notesV10);
    ...
    validateItems: (newDb) async {
      expect(v10_to_v11.usersV11, await newDb.select(newDb.users).get());
expect(v10_to_v11.groupsV11, await newDb.select(newDb.groups).get());
expect(v10_to_v11.notesV11, await newDb.select(newDb.notes).get());
    },
  )
);
