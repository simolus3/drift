...
class Categories extends Table
  ...
  late final TableColumn<int> id = TableColumn<int>(
      ...
      constraints: () => [
            ColumnConstraint.custom(CustomComponent('PRIMARY KEY AUTOINCREMENT',
                dialectSpecificSql: {})),
...
class TodoEntries extends Table
  ...
  late final TableColumn<int> category = TableColumn<int>(
      ...
      requiredDuringInsert: false,
      constraints: () => [
            ColumnConstraint.custom(CustomComponent(
...
base class DatabaseAtV3 extends GeneratedDatabase {
  DatabaseAtV3(super.implementation);
