...
{{ load_snippet('comparison','lib/snippets/dart_api/expressions.dart.excerpt.json') }}

## Boolean algebra
You can nest boolean expressions by using the `&`, `|` operators and the `not` method
exposed by drift:

{{ load_snippet('boolean','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('listand','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('arithmetic','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('nullCheck','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('coalesce','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('isIn','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('averageItemLength','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('counting','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('allTodoContent','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('findTodosInCategory','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
...
{{ load_snippet('custom','lib/snippets/dart_api/expressions.dart.excerpt.json') }}
