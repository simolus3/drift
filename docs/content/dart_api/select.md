...
<Snippet href="/lib/src/snippets/_shared/todo_tables.dart" name="tables" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="limit" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="order-by" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="single" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="mapping" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="selectable" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="joinIntro" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="results" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="custom-columns" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="countTodosInCategories" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="averageItemLength" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="subquery" />
...
<Snippet href="/lib/src/snippets/dart_api/json.dart" name="existing" />

To easily store this contact representation in a drift database, one could use a JSON column:

<Snippet href="/lib/src/snippets/dart_api/json.dart" name="contacts" />
...
<Snippet href="/lib/src/snippets/dart_api/json.dart" name="calls" />
...
<Snippet href="/lib/src/snippets/dart_api/json.dart" name="calls-with-contacts" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="hasTodoItem" />
...
<Snippet href="/lib/src/snippets/dart_api/select.dart" name="compound" />
