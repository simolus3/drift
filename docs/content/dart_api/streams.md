...
<TabItem label="Core query builder" value="core">

<Snippet href="/lib/src/snippets/dart_api/streams.dart" name="core" />

</TabItem>

<TabItem label="Manager" value="manager">

<Snippet href="/lib/src/snippets/dart_api/streams.dart" name="manager" />

</TabItem>

<TabItem label="Custom query" value="custom">

<Snippet href="/lib/src/snippets/dart_api/streams.dart" name="custom" />
...
<TabItem label="Compiled queries" value="compiled">
...
<Snippet href="/lib/src/snippets/dart_api/streams.dart" name="tableUpdates" />
...
<Snippet href="/lib/src/snippets/dart_api/streams.dart" name="markUpdated" />
