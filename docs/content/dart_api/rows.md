...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="table" />
...
<Tabs defaultValue="insert_core">

<TabItem label="Inserts (Manager)" value="insert_manager">

<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="simple-inserts-manager" />
...
<TabItem label="Inserts (Core)" value="insert_core">
...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="simple-inserts-core" />

</TabItem>

<TabItem label="Query (Manager)" value="query_manager">

<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="simple-select-manager" />

</TabItem>

<TabItem label="Query (Core)" value="query_core">

<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="simple-select-core" />
...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="data-class-name" />
...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="generated-value" />
...
<Snippet href="/lib/src/snippets/custom_row_classes/default.dart" name="start" />
...
<Snippet href="/lib/src/snippets/custom_row_classes/default.dart" name="record" />

You can also be explicit about the record type to use:

<Snippet href="/lib/src/snippets/custom_row_classes/default.dart" name="record-explicit" />
...
<Snippet href="/lib/src/snippets/custom_row_classes/named.dart" name="named" />
...
<Snippet href="/lib/src/snippets/custom_row_classes/employees_sql.drift" name="example" />
...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="from-json" />
...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="default-json-keys" />
...
<Snippet href="/lib/src/snippets/dart_api/dataclass.dart" name="custom-json-keys" />
