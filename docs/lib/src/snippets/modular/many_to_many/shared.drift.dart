...
import 'package:drift_website/src/snippets/modular/many_to_many/shared.drift.dart'
    as i1;
import 'package:drift_website/src/snippets/modular/many_to_many/shared.dart'
    as i2;

typedef $$BuyableItemsTableCreateCompanionBuilder =
    i1.BuyableItemsCompanion Function({
      i0.Value<int> id,
      required String description,
      required int price,
    });
typedef $$BuyableItemsTableUpdateCompanionBuilder =
    i1.BuyableItemsCompanion Function({
      i0.Value<int> id,
...
class $$BuyableItemsTableTableManager
    extends
        i0.RootTableManager<
...
typedef $$BuyableItemsTableProcessedTableManager =
