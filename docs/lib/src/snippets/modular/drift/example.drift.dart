...
import 'package:drift_website/src/snippets/modular/drift/example.drift.dart'
    as i1;
import 'package:drift/internal/modular.dart' as i2;

typedef $TodosCreateCompanionBuilder =
    i1.TodosCompanion Function({
      i0.Value<int> id,
  ...
  i1.$CategoriesProcessedTableManager? get category {
    ...
    final manager = i1
        .$CategoriesTableManager(
          $_db,
          i2.ReadDatabaseContainer($_db).resultSet<i1.Categories>('categories'),
        )
...
class $TodosFilterComposer extends i0.Composer<i0.GeneratedDatabase, i1.Todos> {
  ...
  i1.$CategoriesFilterComposer get category {
    final i1.$CategoriesFilterComposer composer = $composerBuilder(
      ...
      referencedTable: i2.ReadDatabaseContainer(
        $db,
      ).resultSet<i1.Categories>('categories'),
      ...
      builder:
          (
            ...
            $db: $db,
            $table: i2.ReadDatabaseContainer(
              $db,
            ).resultSet<i1.Categories>('categories'),
                    ...
                    if (category) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: i1.$TodosReferences
                                    ._categoryTable(db),
                                referencedColumn: i1.$TodosReferences
                                    ._categoryTable(db)
                                    .id,
                              )
                              as T;
...
typedef $CategoriesCreateCompanionBuilder =
    i1.CategoriesCompanion Function({
      i0.Value<int> id,
...
final class $CategoriesReferences
  ...
  i1.$TodosProcessedTableManager get todosRefs {
    final manager = i1
        .$TodosTableManager(
          $_db,
          i2.ReadDatabaseContainer($_db).resultSet<i1.Todos>('todos'),
        )
    ...
    final i1.$TodosFilterComposer composer = $composerBuilder(
      ...
      builder:
          (
            ...
            $db: $db,
            $table: i2.ReadDatabaseContainer($db).resultSet<i1.Todos>('todos'),
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
    ...
    : super(
        i0.TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => i1.CategoriesCompanion(id: id, description: description),
          createCompanionCallback:
              ({
                i0.Value<int> id = const i0.Value.absent(),
                required String description,
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (todosRefs)
                    ...
                    >(
                      currentTable: table,
                      referencedTable: i1.$CategoriesReferences._todosRefsTable(
                        db,
                      ),
...
class Todos extends i0.Table with i0.TableInfo<Todos, i1.Todo> {
  ...
  i0.VerificationContext validateIntegrity(
    i0.Insertable<i1.Todo> instance, {
