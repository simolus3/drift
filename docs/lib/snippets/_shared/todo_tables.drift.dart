...
class $$TodoItemsTableTableManager extends i0.RootTableManager<
  ...
  $$TodoItemsTableTableManager(
      ...
      : super(i0.TableManagerState(
            ...
            table: table,
            filteringComposer:
                $$TodoItemsTableFilterComposer(i0.ComposerState(db, table)),
            orderingComposer:
                $$TodoItemsTableOrderingComposer(i0.ComposerState(db, table)),
...
class $$TodoItemsTableReferenceReader<T0> extends i0
    .ReferenceReader<i1.TodoItem, ({i1.TodoItem todoItem, T0? category})> {
  ...
  @override
  Future<({i1.TodoItem todoItem, T0? category})> $withReferences(
      i1.TodoItem value) async {
    return (todoItem: value, category: await _getCategory(value));
  }

  Future<T0?> _getCategory(i1.TodoItem value) async {
    return $getSingleReferenced<i1.Category>(value.category, _db.categories.id)
        as T0?;
  }

  $$TodoItemsTableReferenceReader<i1.Category> withCategory() {
...
class $$CategoriesTableTableManager extends i0.RootTableManager<
  ...
  $$CategoriesTableTableManager(
      ...
      : super(i0.TableManagerState(
            ...
            table: table,
            filteringComposer:
                $$CategoriesTableFilterComposer(i0.ComposerState(db, table)),
            orderingComposer:
                $$CategoriesTableOrderingComposer(i0.ComposerState(db, table)),
            getChildManagerBuilder: (p0) =>
...
class $$UsersTableTableManager extends i0.RootTableManager<
  ...
  $$UsersTableTableManager(i0.GeneratedDatabase db, i1.$UsersTable table)
      : super(i0.TableManagerState(
            ...
            table: table,
            filteringComposer:
                $$UsersTableFilterComposer(i0.ComposerState(db, table)),
            orderingComposer:
                $$UsersTableOrderingComposer(i0.ComposerState(db, table)),
            getChildManagerBuilder: (p0) =>
