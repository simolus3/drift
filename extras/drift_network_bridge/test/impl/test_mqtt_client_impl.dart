...
class _RemoteQueryExecutor extends _BaseExecutor {
  _RemoteQueryExecutor(MqttDriftClient client, [int? executorId])
...
class _RemoteTransactionExecutor extends _BaseExecutor
  ...
  _RemoteTransactionExecutor(MqttDriftClient client, this._outerExecutorId)
      : super(client);
