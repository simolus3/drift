...
@optionalTypeArgs
abstract interface class Insertable<D> {
...
/// A common supertype for all data classes generated by drift in the legacy v2
/// generation mode. Data classes are immutable structures that represent a
/// single row in a database table.
abstract class LegacyDataClass {
  /// Constant constructor so that generated data classes can be constant.
  const LegacyDataClass();
...
/// An update companion for a row which is used to write data into a database
