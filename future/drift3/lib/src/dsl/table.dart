...
import '../query_builder/clauses/order_by.dart';
...
abstract class Table extends ResultSetDsl {
  ...
  @protected
  ColumnBuilder<int> intEnum<T extends Enum>() => isGenerated();
  ...
  ColumnBuilder<String> textEnum<T extends Enum>() => isGenerated();
  ...
  ColumnBuilder<T> customType<T extends Object>(SqlType<T> type) =>
      isGenerated();

  /// Defines a column with a non-standard SQL [type].
  ///
  /// For more information on custom types and when they can be useful, see
  /// https://drift.simonbinder.eu/docs/sql-api/types/.
  ///
  ...
  /// custom values in the database.
  @protected
  ColumnBuilder<T> col<T extends Object>(SqlType<T> type) => isGenerated();
}
...
abstract class View extends ResultSetDsl {
  ...
  @protected
  View select(List<Expression> columns) => isGenerated();
  ...
  /// ```
  @protected
  BaseSelectStatement from(Table table) => isGenerated();
