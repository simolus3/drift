...
extension Fts5Extensions on VirtualTableInfo {
  ...
  /// [alias] is used as the column name here.
  SchemaColumn<String> get _tableReference =>
      SchemaColumn<String>(name: entityName, sqlType: .text)
  ...
  Expression<bool> matchExp(Expression<String> expression) {
    return BinaryExpression(_tableReference, .match, expression);
  }
  ...
  Expression<double> get rank =>
      SchemaColumn<double>(name: 'rank', sqlType: .double)
        ..owningResultSet = this;
  ...
  int _columnIndex(SchemaColumn<String> column) {
