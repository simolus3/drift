...
class JoinBuilder {
  ...
  String get aliasedName {
    return referencedTable.aliasOrName;
  }
  ...
  Join buildJoin() {
    return .leftOuter(
      referencedTable,
      on: currentColumn.equalsExp(referencedColumn),
      includeInResult: useColumns,
    );
  }
}
