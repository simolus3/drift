...
/// {@macro manager_internal_use_only}
@optionalTypeArgs
class MultiTypedResultKey<$Dataclass extends Object> extends Table
    with ResultSet<$Dataclass, MultiTypedResultKey<$Dataclass>>
    implements GeneratedTable<$Dataclass, MultiTypedResultKey<$Dataclass>> {
  @override
  ...
  @override
  MultiTypedResultKey<$Dataclass> asSelfType() => this;

  MultiTypedResultKey._({
  ...
  static MultiTypedResultKey<List<$Dataclass>> fromTable<
    $Table extends GeneratedTable<$Dataclass, $Table>,
    $Dataclass extends Object
  >($Table table, {required String aliasName}) {
    return MultiTypedResultKey<List<$Dataclass>>._(
  ...
  @override
  MultiTypedResultKey<$Dataclass> withAlias(String alias) {
  ...
  bool operator ==(Object other) {
    if (other is MultiTypedResultKey<$Dataclass>) {
  ...
  @override
  $Dataclass? Function(RawRow) createMapperFromPositions(
    DriftDialect dialect,
    List<ColumnPosition> positions,
  ) {
    throw UnsupportedError("Can't map MultiTypedResultKeys");
  }
}
...
Future<List<MultiTypedResultEntry<$ReferencedDataclass>>> $_getPrefetchedData<
  $CurrentDataclass extends Object,
  $CurrentTable extends GeneratedTable<$CurrentDataclass, $CurrentTable>,
  $ReferencedDataclass extends Object
>({
