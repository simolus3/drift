...
class Composer<Database extends GeneratedDatabase, CurrentTable extends Table> {
  ...
  T $composerBuilder<
    ...
    RelatedColumn extends TableColumn
  >({
    ...
    final aliasName = $_aliasNameGenerator(
      (_aliasedTable as GeneratedTable),
      aliasedColumn,
      (referencedTable as GeneratedTable),
      referencedColumn,
    );

    final aliasedReferencedTable = (referencedTable as GeneratedTable)
        .withAlias(aliasName);
    ...
    final referencedJoinBuilder = JoinBuilder(
      currentTable: _aliasedTable as GeneratedTable,
      currentColumn: aliasedColumn,
      referencedTable: aliasedReferencedTable as GeneratedTable,
  ...
  AliasedColumn _aliasedColumn<AliasedColumn extends TableColumn>(
    AliasedColumn column,
  ) {
    return (_aliasedTable as GeneratedTable).columnsByName[column.name]
        as AliasedColumn;
  }
