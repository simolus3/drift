...
class _Fake$CategoriesTable_2 extends _i1.SmartFake
  ...
  _Fake$CategoriesTable_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$TodosTableTable_3 extends _i1.SmartFake
    implements _i3.$TodosTableTable {
  _Fake$TodosTableTable_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class _Fake$SharedTodosTable_5 extends _i1.SmartFake
  ...
  _Fake$SharedTodosTable_5(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$TableWithoutPKTable_6 extends _i1.SmartFake
    implements _i3.$TableWithoutPKTable {
  _Fake$TableWithoutPKTable_6(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$PureDefaultsTable_7 extends _i1.SmartFake
    implements _i3.$PureDefaultsTable {
  _Fake$PureDefaultsTable_7(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$WithCustomTypeTable_8 extends _i1.SmartFake
    implements _i3.$WithCustomTypeTable {
  _Fake$WithCustomTypeTable_8(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockTodoDb extends _i1.Mock implements _i3.TodoDb {
  ...
  set migration(_i2.MigrationStrategy? _migration) => super.noSuchMethod(
    Invocation.setter(#migration, _migration),
  ...
  set schemaVersion(int? _schemaVersion) => super.noSuchMethod(
    Invocation.setter(#schemaVersion, _schemaVersion),
    returnValueForMissingStub: null,
  );
  ...
  _i3.$StoreTable get store =>
      (super.noSuchMethod(
            ...
            returnValue: _Fake$StoreTable_12(this, Invocation.getter(#store)),
  ...
  _i3.SomeDao get someDao =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeSomeDao_16(this, Invocation.getter(#someDao)),
