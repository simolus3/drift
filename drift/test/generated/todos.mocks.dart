...
class MockTodoDb extends _i1.Mock implements _i2.TodoDb {
  @override
  set migration(dynamic _migration) => super.noSuchMethod(
        Invocation.setter(
          #migration,
          _migration,
        ),
  ...
  @override
  set options(dynamic _options) => super.noSuchMethod(
        Invocation.setter(
          #options,
          _options,
        ),
