...
class WithDefaults extends Table with TableInfo<WithDefaults, WithDefault> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<WithDefault> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class WithDefault extends DataClass implements Insertable<WithDefault> {
  ...
  factory WithDefault.fromJsonString(
    String encodedJson, {
    ValueSerializer? serializer,
...
class WithConstraints extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<WithConstraint> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  WithConstraint map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WithConstraint(
      ...
      c: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
...
class WithConstraint extends DataClass implements Insertable<WithConstraint> {
  ...
  factory WithConstraint.fromJsonString(
    String encodedJson, {
    ValueSerializer? serializer,
...
class Mytable extends Table with TableInfo<Mytable, MytableData> {
  ...
  static const VerificationMeta _sometextMeta = const VerificationMeta(
    'sometext',
  );
  ...
  static const VerificationMeta _isInsertingMeta = const VerificationMeta(
    'isInserting',
  );
  ...
  static const VerificationMeta _somedateMeta = const VerificationMeta(
    'somedate',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('is_inserting')) {
      context.handle(
        _isInsertingMeta,
        this.isInserting.isAcceptableOrUnknown(
          data['is_inserting']!,
          _isInsertingMeta,
        ),
      );
  ...
  MytableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return MytableData(
      someid: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}someid'],
      )!,
      sometext: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sometext'],
      ),
      isInserting: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_inserting'],
      ),
      somedate: attachedDatabase.typeMapping.read(
...
class MytableData extends DataClass implements Insertable<MytableData> {
  ...
  factory MytableData.fromJsonString(
    String encodedJson, {
    ValueSerializer? serializer,
...
class WeirdTable extends Table with TableInfo<WeirdTable, WeirdData> {
  ...
  static const VerificationMeta _sqlClassMeta = const VerificationMeta(
    'sqlClass',
  );
  ...
  static const VerificationMeta _textColumnMeta = const VerificationMeta(
    'textColumn',
  );
  ...
  WeirdData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WeirdData(
      sqlClass: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}class'],
      )!,
      textColumn: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class WeirdData extends DataClass implements Insertable<WeirdData> {
  ...
  factory WeirdData.fromJsonString(
    String encodedJson, {
    ValueSerializer? serializer,
  }) => WeirdData.fromJson(
    DataClass.parseJson(encodedJson) as Map<String, dynamic>,
...
class MyViewData extends DataClass {
  ...
  factory MyViewData.fromJsonString(
    String encodedJson, {
    ValueSerializer? serializer,
  }) => MyViewData.fromJson(
    DataClass.parseJson(encodedJson) as Map<String, dynamic>,
...
abstract class _$CustomTablesDb extends GeneratedDatabase {
  ...
  Selectable<MultipleResult> multiple({required Multiple$predicate predicate}) {
    ...
    return customSelect(
      ...
      (QueryRow row) async => MultipleResult(
        row: row,
  ...
  Selectable<int> cfeTest() {
    return customSelect(
      ...
      variables: [],
      readsFrom: {},
    ).map((QueryRow row) => row.read<int>('x'));
  }
...
typedef $NoIdsCreateCompanionBuilder =
    NoIdsCompanion Function({required Uint8List payload});
typedef $NoIdsUpdateCompanionBuilder =
    NoIdsCompanion Function({Value<Uint8List> payload});
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({Value<Uint8List> payload = const Value.absent()}) =>
                  NoIdsCompanion(payload: payload),
...
typedef $NoIdsProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $WithDefaultsCreateCompanionBuilder =
    WithDefaultsCompanion Function({
      Value<String?> a,
      Value<int?> b,
      Value<int> rowid,
    });
typedef $WithDefaultsUpdateCompanionBuilder =
    WithDefaultsCompanion Function({
      Value<String?> a,
      Value<int?> b,
      Value<int> rowid,
...
class $WithDefaultsTableManager
    extends
        RootTableManager<
          _$CustomTablesDb,
          WithDefaults,
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => WithDefaultsCompanion(a: a, b: b, rowid: rowid),
...
typedef $WithDefaultsProcessedTableManager =
    ProcessedTableManager<
      _$CustomTablesDb,
      WithDefaults,
      WithDefault,
      ...
      PrefetchHooks Function()
    >;
typedef $WithConstraintsCreateCompanionBuilder =
    WithConstraintsCompanion Function({
      Value<String?> a,
      required int b,
      Value<double?> c,
      Value<int> rowid,
    });
typedef $WithConstraintsUpdateCompanionBuilder =
    WithConstraintsCompanion Function({
      Value<String?> a,
      Value<int> b,
      Value<double?> c,
...
class $WithConstraintsTableManager
    extends
        RootTableManager<
          _$CustomTablesDb,
          WithConstraints,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<double?> c = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => WithConstraintsCompanion(a: a, b: b, c: c, rowid: rowid),
          createCompanionCallback:
              ({
                Value<String?> a = const Value.absent(),
                required int b,
...
typedef $WithConstraintsProcessedTableManager =
    ProcessedTableManager<
      _$CustomTablesDb,
      WithConstraints,
      WithConstraint,
...
typedef $ConfigTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $MytableCreateCompanionBuilder =
...
typedef $MytableUpdateCompanionBuilder =
    MytableCompanion Function({
      Value<int> someid,
      Value<String?> sometext,
      Value<bool?> isInserting,
...
typedef $MytableProcessedTableManager =
    ProcessedTableManager<
      _$CustomTablesDb,
      Mytable,
      MytableData,
...
typedef $EmailProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $WeirdTableCreateCompanionBuilder =
    WeirdTableCompanion Function({
      required int sqlClass,
      required String textColumn,
      Value<int> rowid,
    });
typedef $WeirdTableUpdateCompanionBuilder =
    WeirdTableCompanion Function({
      Value<int> sqlClass,
      Value<String> textColumn,
      Value<int> rowid,
...
typedef $WeirdTableProcessedTableManager =
    ProcessedTableManager<
      _$CustomTablesDb,
      WeirdTable,
      WeirdData,
...
class JsonResult extends CustomResultSet {
  final String key;
  final String? value;
  JsonResult({required QueryRow row, required this.key, this.value})
    : super(row);
  @override
