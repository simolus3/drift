...
class $TodoItemsTable extends TodoItems
  ...
  Set<TableColumn> get primaryKey => {id};
  @override
  TodoItem? Function(DriftRow) createMapperFromPositions(
      List<ColumnPosition> positions) {
    return (DriftRow row) {
      // Not part of row if non-nullable column "id" is missing
      if (row.raw.rawValue(positions[0]) == null) {
      ...
      return TodoItem(
        ...
        categoryId: row.readWithType(positions[3], BuiltinDriftType.int)!,
        generatedText: row.readWithType(positions[4], BuiltinDriftType.text),
      );
    };
  }
...
class $TodoCategoryItemCountView extends TodoCategoryItemCount
  ...
  @override
  TodoCategoryItemCountData? Function(DriftRow) createMapperFromPositions(
      List<ColumnPosition> positions) {
    return (DriftRow row) {
      ...
      return TodoCategoryItemCountData(
        name: row.readWithType(positions[0], BuiltinDriftType.text)!,
        itemCount: row.readWithType(positions[1], BuiltinDriftType.int),
      );
    };
  }
...
class $TodoItemWithCategoryNameViewView extends TodoItemWithCategoryNameView
  ...
  @override
  TodoItemWithCategoryNameViewData? Function(DriftRow)
      createMapperFromPositions(List<ColumnPosition> positions) {
    return (DriftRow row) {
      // Not part of row if non-nullable column "id" is missing
      if (row.raw.rawValue(positions[0]) == null) {
        return null;
