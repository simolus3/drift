...
Future<void> main() async {
  ...
  final db = Database(SqliteConnection.synchronous(open: () {
...
*/
  ...
  final query = db.select(db.todoItems).innerJoin(db.todoCategories,
      on: db.todoCategories.id.equalsExp(db.todoItems.categoryId));
