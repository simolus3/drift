...
final class Batch {
  ...
  BatchedStatement _addStatement(SqlStatement stmt) {
    ...
    return _addCustomStatement(StatementInfo(built));
  }
  ...
  void insertAllOnConflictUpdate<Row extends Object,
  ...
  ///    [Batch].
  BatchedStatement
      replace<Row extends Object, RS extends GeneratedTable<Row, RS>>(
  ...
  ///  - [DatabaseConnectionUser.delete]
  BatchedStatement
      deleteWhere<Row extends Object, RS extends GeneratedTable<Row, RS>>(
          GeneratedTable<Row, RS> table,
          Expression<bool> Function(RS tbl) filter) {
  ...
  ///  - [DatabaseConnectionUser.delete]
  BatchedStatement
      deleteAll<Row extends Object, RS extends GeneratedTable<Row, RS>>(
          GeneratedTable<Row, RS> table) {
  ...
  BatchedStatement customStatement(
    String sql, [
    List<TypedNullableValue> args = const [],
  ...
  Future<BatchResult> _run() async {
    return await _database.transaction(() async {
      ...
      final results = await session
          .executeBatch(StatementBatch(sql: _sql, statements: _statements));
