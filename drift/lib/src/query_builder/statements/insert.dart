...
final class InsertStatement<Row extends Object,
  ...
  @override
  final BuiltMap<Symbol, Object?> dialectSpecificOptions;
  ...
  InsertStatement(this._database, this.table)
      : source = null,
        upsertClause = null,
        dialectSpecificOptions = BuiltMap(),
        returning = null;
  ...
  InsertStatement._(
    ...
    required this.dialectSpecificOptions,
  });
  @internal
  InsertStatement<Row, RS> copyWith({
    InsertSource? source,
    UpsertClause<Row, RS>? upsertClause,
    ReturningClause<Row, RS>? returning,
    BuiltMap<Symbol, Object?>? dialectSpecificOptions,
  }) {
    assert(
    ...
    return InsertStatement<Row, RS>._(
      ...
      dialectSpecificOptions:
          dialectSpecificOptions ?? this.dialectSpecificOptions,
    );
  }
    ...
    columns.forEach((key, value) {
      ...
      if (position == null) {
        throw ArgumentError.value(
            value,
            'column',
            'This column passed to insertFromSelect() was not added to the '
  ...
  InsertStatement<Row, RS> onConflict(UpsertClause<Row, RS> upsert) {
    return copyWith(upsertClause: upsert);
  }
...
final class DoUpdate<Row extends Object, RS extends GeneratedTable<Row, RS>>
  ...
  final BuiltList<TableColumn>? target;
