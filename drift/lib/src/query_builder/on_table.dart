...
/// tables.
extension TableStatements<Row extends Object,
    RS extends GeneratedTable<Row, RS>> on GeneratedTable<Row, RS> {
  ...
  Future<Row> insertReturning(
    ...
    return insert().onDatabase(database).insertReturning(
          row,
  ...
  Future<Row?> insertReturningOrNull(
    ...
    return insert().onDatabase(database).insertReturningOrNull(
          row,
          onConflict: onConflict,
        );
  }
