...
extension BooleanExpressionOperators on Expression<bool> {
  ...
  Expression<bool> operator &(Expression<bool> other) {
    return BinaryExpression(this, BinaryOperator.and, other,
  ...
  Expression<bool> operator |(Expression<bool> other) {
    return BinaryExpression(this, BinaryOperator.or, other,
        resolveType: _resolveType);
  }

  static SqlType<bool> _resolveType(DriftDialect dialect) => dialect.boolType;
}
