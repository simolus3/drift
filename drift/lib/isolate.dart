...
///
/// Please note that most of this API does not supported web.
library;
...
export 'isolate_extension/isolate_extension_native.dart'
    if (dart.library.js) 'isolate_extension/isolate_web.dart';
