...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  @override
  late final GeneratedColumn<BigInt> group = GeneratedColumn<BigInt>(
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      group: attachedDatabase.typeMapping
          .read(DriftSqlType.bigInt, data['${effectivePrefix}group'])!,
    );
  }
...
class User extends DataClass implements Insertable<User> {
  ...
  final String name;
  final BigInt group;
  const User({required this.id, required this.name, required this.group});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['name'] = Variable<String>(name);
    map['group'] = Variable<BigInt>(group);
    return map;
  }
  ...
  factory User.fromJson(Map<String, dynamic> json,
    ...
    return User(
      id: serializer.fromJson<int>(json['id']),
      name: serializer.fromJson<String>(json['name']),
      group: serializer.fromJson<BigInt>(json['group']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'name': serializer.toJson<String>(name),
      'group': serializer.toJson<BigInt>(group),
    };
  }

  User copyWith({int? id, String? name, BigInt? group}) => User(
        id: id ?? this.id,
        name: name ?? this.name,
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  UsersCompanion.insert({
    this.id = const Value.absent(),
    required String name,
    required BigInt group,
  })  : name = Value(name),
        group = Value(group);
  static Insertable<User> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<BigInt>? group,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (name != null) 'name': name,
  ...
  UsersCompanion copyWith(
      {Value<int>? id, Value<String>? name, Value<BigInt>? group}) {
    return UsersCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      group: group ?? this.group,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (group.present) {
      map['group'] = Variable<BigInt>(group.value);
    }
    return map;
  }
...
abstract class _$TestDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [groups, users];
}
...
class $$GroupsTableFilterComposer
    extends Composer<_$TestDatabase, $GroupsTable> {
...
class $$GroupsTableTableManager extends RootTableManager<
    ...
    (Group, BaseReferences<_$TestDatabase, $GroupsTable, Group>),
    Group,
    PrefetchHooks Function()> {
  $$GroupsTableTableManager(_$TestDatabase db, $GroupsTable table)
  ...
  $$UsersTableTableManager(_$TestDatabase db, $UsersTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<BigInt> group = const Value.absent(),
          }) =>
              UsersCompanion(
            id: id,
            name: name,
