...
class GenerationOptions {
  ...
  /// Whether the [DriftOptions.preamble] should be written.
  ///
  /// We disable this when drift is generating part files picked up by the
  /// combining builder from `source_gen`, because users should set their
  /// preamble there.
  final bool writePreamble;
