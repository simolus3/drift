...
DriftOptions _$DriftOptionsFromJson(Map json) => $checkedCreate(
  ...
  ($checkedConvert) {
    $checkKeys(
      ...
      allowedKeys: const [
        ...
        'use_sql_table_name_for_accessors',
    ...
    final val = DriftOptions(
      ...
      useSqlTableNameForAccessors: $checkedConvert(
        'use_sql_table_name_for_accessors',
        (v) => v as bool? ?? false,
      ),
      ...
      generateMutableClasses: $checkedConvert(
        'mutable_classes',
        (v) => v as bool? ?? false,
      ),
      ...
      generateNamedParameters: $checkedConvert(
        'named_parameters',
        (v) => v as bool? ?? false,
      ),
      ...
      testDir: $checkedConvert('test_dir', (v) => v as String? ?? 'test/drift'),
  ...
  fieldKeyMap: const {
    ...
    'useSqlTableNameForAccessors': 'use_sql_table_name_for_accessors',
...
Map<String, dynamic> _$DriftOptionsToJson(
  DriftOptions instance,
) => <String, dynamic>{
  ...
  'use_data_class_name_for_companions': instance.useDataClassNameForCompanions,
  'use_sql_table_name_for_accessors': instance.useSqlTableNameForAccessors,
  'use_column_name_as_json_key_when_defined_in_moor_file':
...
DialectOptions _$DialectOptionsFromJson(Map json) =>
    $checkedCreate('DialectOptions', json, ($checkedConvert) {
      $checkKeys(json, allowedKeys: const ['dialect', 'dialects', 'options']);
      final val = DialectOptions(
        $checkedConvert(
          'dialect',
          (v) => $enumDecodeNullable(_$SqlDialectEnumMap, v),
        ),
        $checkedConvert(
          'dialects',
          (v) => (v as List<dynamic>?)
...
Map<String, dynamic> _$DialectOptionsToJson(
  DialectOptions instance,
) => <String, dynamic>{
  'dialect': _$SqlDialectEnumMap[instance.dialect],
  'dialects': instance.dialects?.map((e) => _$SqlDialectEnumMap[e]!).toList(),
